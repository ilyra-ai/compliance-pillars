      ...
      <main className="pb-16 pt-24 md:ml-64 px-4 md:px-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="mb-6">
            ...
            <TabsTrigger value="ui">Personalizar UI</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="ui">
            <Card>
              <CardHeader>
                <CardTitle>Personalizar UI</CardTitle>
                <CardDescription>Configure as cores, fontes e tema da interface</CardDescription>
              </CardHeader>
              <CardContent>
